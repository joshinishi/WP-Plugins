 ...
 */
function create_block_guterburg_block_block_init() {
	register_block_type( __DIR__ . '/build' );
}
add_action( 'init', 'create_block_guterburg_block_block_init' );

function loadmyblockfiles() {
	wp_enqueue_script(
		'my_super_unique_handle',
